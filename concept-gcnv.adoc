...
Google Cloud NetApp Volumes建立的磁碟區將從您的服務訂閱中扣除費用，而不是透過NetApp Console 扣除。

從NetApp控制台發現Google Cloud NetApp Volumes區域或磁碟區無需付費。
...
* https://docs.netapp.com/us-en/data-services-copy-sync/index.html["NetApp控制台複製和同步文檔"^]
